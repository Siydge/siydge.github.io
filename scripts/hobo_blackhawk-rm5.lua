--this one is currently modified for blackhawk 5
--[[
...
if settings['Aimbot']['enabled'] then 
	if (closest.dis > 1.3 or not settings['Aimbot']['jitter_fix']) and closest.dis3 then 
	    v.FirstPersonAim({closest.pos2.x,closest.pos2.y-closest.dis3/settings['Aimbot']['dropdown_prediction']},settings['Aimbot']['smoothness'],settings['Aimbot']['sensitivity'])
    end
